...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product(4, "Premium Quality Californian Almond Nuts", 12, "USD", "Almonds originated in the warm desert areas of westerrn Asia, from which they gradually spread to the warm, dry regions of the Mediterranean basin.", edibleNuts, amazon));
    }
}
